...
model.model(X_train, Y_train, X_test, Y_test, layers=[X_train.shape[0], 500, 300, 100, 10], learning_rate=0.01, beta1=0.9, beta2=0.999, epochs=20, mb_size=128, keep_prob=0.8)